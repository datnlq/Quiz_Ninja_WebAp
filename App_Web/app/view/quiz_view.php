<?php
include '../controller/load_question.php';
...
<body>
	...
	<form action="" method="POST" class="question">
		<div class="addques">
			<button name="addques" class="button">Add Question</button>
		</div>
	</form>
	...
	<div class="result_box">
        <div class="icon">
            <img src="../css/images/akat.png" alt="Akatsuki"height="71" width="100">
        </div>
...
/*  	{
    ...
    const add = document.querySelector(".addques button");
	...
	{
	  let questionn = questions[que_count].question ;
